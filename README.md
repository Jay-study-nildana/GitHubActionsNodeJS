...
TODO1. for the sake of deployment, I have allowed env files to be pushed to the repository. Ideally, we should be able to get this from github secrets or some such.

TODO2. Also, how can I collect the connection string of, mongo db, for example, from github secrets?
